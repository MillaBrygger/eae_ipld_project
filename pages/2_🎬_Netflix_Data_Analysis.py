...
num_missing_directors = movies_df["director"].shape[0]-(movies_df["director"].count())
...
top_10_countries = movies_year["country"].value_counts().head(10) 
...
movies_df.loc[:,"min_duration"] = movies_df["duration"].apply(lambda x: x[:-4])
